(function (wp) {
    ...
    registerBlockType('mycred-blocks/mycred-my-ranks', {
        title: __('My Ranks', 'mycred-gutenberg'),
        description: __('This Block allows you to show all ranks a user currently has. Note that this is only usable when you have ranks for multiple point types.', 'mycred-gutenberg'),
        category: 'mycred',
        attributes: {
            user_id: {
                type: 'string'
        ...
        edit: function (props) {
            ...
            return el('div', {}, [
                el('p', {}, __('My Ranks Shortcode', 'mycred-gutenberg')
                        ),
