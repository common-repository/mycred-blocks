(function (wp) {
    ...
    registerBlockType('mycred-blocks/mycred-video', {
        title: __('Video', 'mycred-gutenberg'),
        category: 'mycred',
        attributes: {
            video_id: {
                type: 'string'
        ...
        edit: function (props) {
            ...
            return el('div', {}, [
                el('p', {}, __('Video Shortcode', 'mycred-gutenberg')
                        ),
                el(InspectorControls, null,
                        el(TextControl, {
                            label: __('Video ID', 'mycred-gutenberg'),
                            help: __('Required video ID to show. No URls or embed codes! Just the video ID', 'mycred-gutenberg'),
                            value: video_id,
                            onChange: setVideoId
                        }),
                        el(TextControl, {
                            label: __('Width', 'mycred-gutenberg'),
                            help: __('Width of the Iframe', 'mycred-gutenberg'),
                            value: width,
                            onChange: setWidth
                        }),
                        el(TextControl, {
                            label: __('Height', 'mycred-gutenberg'),
                            help: __('Height of the Iframe.', 'mycred-gutenberg'),
                            value: height,
                            onChange: setHeight
                        }),
                        el(TextControl, {
                            label: __('Amount', 'mycred-gutenberg'),
                            help: __('The amount of points to give users for watching this video. Leave empty to use your default settings.', 'mycred-gutenberg'),
                            value: amount,
                            onChange: setAmount
                        }),
                        el(SelectControl, {
                            label: __('Logic', 'mycred-gutenberg'),
                            help: __('The award logic to use', 'mycred-gutenberg'),
                            value: logic,
                            onChange: setLogic,
                            options: [
                        ...
                        el(TextControl, {
                            label: __('Interval', 'mycred-gutenberg'),
                            help: __('Number of seconds that a user must watch to get points. Only use this if you have set "Logic" to "Interval".', 'mycred-gutenberg'),
                            value: interval,
