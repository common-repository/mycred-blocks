(function (wp) {
    ...
    registerBlockType('mycred-blocks/mycred-total-since', {
        title: __('Total Since', 'mycred-gutenberg'),
        category: 'mycred',
        attributes: {
            from: {
                type: 'string'
        ...
        edit: function (props) {
            ...
            return el('div', {}, [
                el('p', {}, __('Total Since Shortcode', 'mycred-gutenberg')
                        ),
                el(InspectorControls, null,
                        el(TextControl, {
                            label: __('From', 'mycred-gutenberg'),
                            help: __('Option to set from when we should start adding up points. Accepts: "today" for start of today, a UNIX timestamp or a well formatted date. See PHPs strtotime for further information on available options.', 'mycred-gutenberg'),
                            value: from,
                            onChange: setFrom
                        ...
                        el(TextControl, {
                            ...
                            help: __('Option to set what time to stop counting. Accepts: "now" for now, a UNIX timestamp or a well formatted date. See PHPs strtotime for further information on available options.', 'mycred-gutenberg'),
                            value: until,
                            onChange: setUntil
                        ...
                        el(TextControl, {
                            ...
                            help: __('Option to filter results based on a reference.', 'mycred-gutenberg'),
                            value: ref,
                            onChange: setRef
                        }),
                        el(TextControl, {
